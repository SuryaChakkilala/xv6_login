...
This project was done as part of an `Introduction to Operating Systems` course at PES University.

#### Contributions 

I would like to thank [Aditi Srinivas](https://github.com/aditisrinivas97) for finding the right function call used by the keyboard driver so as to enable disabling echo of the keyboard input while the password is typed into the console.
